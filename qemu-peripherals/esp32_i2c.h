...
typedef enum {
  ESP32S3_I2C_OPCODE_WRITE = 1,
  ESP32S3_I2C_OPCODE_STOP = 2,
  ESP32S3_I2C_OPCODE_READ = 3,
  ESP32S3_I2C_OPCODE_END = 4,
  ESP32S3_I2C_OPCODE_RSTART = 6,
} esp32s3_i2c_opcode_t;

/* FreeRTOS queue 傳送在 simulator 內被略過；保留硬體交易結果，讓同步
 * ESP-IDF I2C driver 的 queue receive 仍可取得 DONE/NACK 事件。 */
