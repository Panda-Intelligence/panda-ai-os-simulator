...
DEF_HELPER_3(exception_cause, void, env, i32, i32)
DEF_HELPER_4(exception_cause_vaddr, void, env, i32, i32, i32)
DEF_HELPER_3(debug_exception, noreturn, env, i32, i32)
DEF_HELPER_1(mofei_bump_malloc, void, env)
DEF_HELPER_8(mofei_bump_alloc_kind, i32, env, i32, i32, i32, i32, i32, i32, i32)
DEF_HELPER_1(mofei_bump_queue_create, void, env)
DEF_HELPER_0(mofei_next_queue_handle, i32)
DEF_HELPER_2(mofei_skip_fn_i2c_transfer, i32, env, i32)
DEF_HELPER_1(mofei_gpio_get_level, i32, env)
DEF_HELPER_1(mofei_try_spi_radio_transfer, i32, env)
DEF_HELPER_1(mofei_jump_to_app_main, void, env)
DEF_HELPER_2(mofei_enter_murphy_run_loop, i32, env, i32)
DEF_HELPER_1(mofei_start_murphy_simulator_loop, i32, env)
DEF_HELPER_1(mofei_prepare_murphy_simulator_loop_frame, i32, env)
DEF_HELPER_1(mofei_maybe_jump_to_loop_task, void, env)
DEF_HELPER_1(mofei_assert_redirect, void, env)
DEF_HELPER_1(mofei_retw_success, void, env)
DEF_HELPER_1(mofei_retw_queue_receive, void, env)
DEF_HELPER_1(mofei_retw_null, void, env)
DEF_HELPER_1(mofei_retw_time_us, void, env)
DEF_HELPER_0(mofei_time_us, i64)
DEF_HELPER_1(mofei_retw_fail, void, env)
DEF_HELPER_1(mofei_retw_intr_alloc, void, env)
DEF_HELPER_1(mofei_retw_intr_alloc_intrstatus, void, env)
DEF_HELPER_1(mofei_sdmmc_wait_for_event, i32, env)
DEF_HELPER_2(mofei_retw_safe, i32, env, i32)
DEF_HELPER_1(mofei_skip_fn_bump_malloc, i32, env)
DEF_HELPER_1(mofei_skip_fn_wrapped_malloc, i32, env)
DEF_HELPER_4(mofei_skip_fn_bump_alloc_kind, i32, env, i32, i32, i32)
DEF_HELPER_1(mofei_skip_fn_atomic_exchange_1, i32, env)
DEF_HELPER_1(mofei_skip_fn_atomic_fetch_add_2, i32, env)
DEF_HELPER_1(mofei_skip_fn_atomic_fetch_add_4, i32, env)
DEF_HELPER_1(mofei_skip_fn_atomic_compare_exchange_1, i32, env)
DEF_HELPER_1(mofei_skip_fn_atomic_compare_exchange_4, i32, env)
DEF_HELPER_4(mofei_s32c1i, i32, env, i32, i32, i32)
DEF_HELPER_4(mofei_s32ex, i32, env, i32, i32, i32)
DEF_HELPER_1(mofei_heap_caps_get_free_size, i32, env)
DEF_HELPER_1(mofei_heap_caps_get_largest_free_block, i32, env)
DEF_HELPER_1(mofei_heap_caps_get_total_size, i32, env)
DEF_HELPER_1(mofei_heap_caps_get_allocated_size, i32, env)
DEF_HELPER_1(mofei_esp_get_psram_size, i32, env)
DEF_HELPER_1(mofei_esp_get_free_psram, i32, env)
DEF_HELPER_1(mofei_esp_get_max_alloc_psram, i32, env)
DEF_HELPER_1(mofei_inject_framebuffer, void, env)
DEF_HELPER_3(mofei_trace_activity, void, env, i32, i32)
DEF_HELPER_7(mofei_trace_murphy_activity, void, env, i32, i32, i32, i32, i32, i32)
DEF_HELPER_3(mofei_trace_epub_pipeline, void, env, i32, i32)
DEF_HELPER_1(mofei_throttle_loop, void, env)
DEF_HELPER_1(mofei_redirect_to_goToBoot, void, env)
DEF_HELPER_2(mofei_callx_intercept, void, env, i32)
DEF_HELPER_2(mofei_startup_sync_flags, void, env, i32)
DEF_HELPER_1(mofei_debug_print_a0, void, env)
DEF_HELPER_2(mofei_publish_hook_return, i32, env, i32)
DEF_HELPER_1(mofei_memset, i32, env)
DEF_HELPER_1(mofei_memcpy, i32, env)
DEF_HELPER_1(mofei_strcmp, i32, env)
DEF_HELPER_1(mofei_strlen, i32, env)
DEF_HELPER_1(mofei_strdup, i32, env)
DEF_HELPER_1(mofei_cxa_guard_acquire, i32, env)
DEF_HELPER_1(mofei_cxa_guard_release, i32, env)
DEF_HELPER_4(mofei_memset_direct, i32, env, i32, i32, i32)
DEF_HELPER_4(mofei_memcpy_direct, i32, env, i32, i32, i32)
DEF_HELPER_3(mofei_strcmp_direct, i32, env, i32, i32)
DEF_HELPER_2(mofei_strlen_direct, i32, env, i32)
DEF_HELPER_2(mofei_strdup_direct, i32, env, i32)
DEF_HELPER_5(mofei_divdi3_direct, i32, env, i32, i32, i32, i32)
DEF_HELPER_5(mofei_moddi3_direct, i32, env, i32, i32, i32, i32)
DEF_HELPER_5(mofei_udivdi3_direct, i32, env, i32, i32, i32, i32)
DEF_HELPER_5(mofei_umoddi3_direct, i32, env, i32, i32, i32, i32)
DEF_HELPER_1(mofei_pthread_key_create, i32, env)
DEF_HELPER_1(mofei_pthread_getspecific, i32, env)
DEF_HELPER_1(mofei_pthread_setspecific, i32, env)
DEF_HELPER_1(mofei_skip_fn_void, i32, env)
DEF_HELPER_1(mofei_skip_fn_return_zero, i32, env)
DEF_HELPER_1(mofei_skip_fn_return_one, i32, env)
DEF_HELPER_1(mofei_gpio_set_level, i32, env)
DEF_HELPER_1(mofei_esp_efuse_read_field_blob, i32, env)
DEF_HELPER_5(mofei_touch_read, i32, env, i32, i32, i32, i32)
DEF_HELPER_3(mofei_button_read, i32, env, i32, i32)
DEF_HELPER_3(mofei_trace_file_browser_directory, i32, env, i32, i32)
DEF_HELPER_2(mofei_trace_rpipe, i32, env, i32)
DEF_HELPER_4(mofei_trace_opds_fetch, i32, env, i32, i32, i32)
DEF_HELPER_3(mofei_trace_opds_search, i32, env, i32, i32)
DEF_HELPER_2(mofei_spi_cmd, i32, env, i32)
DEF_HELPER_2(mofei_spi_data, i32, env, i32)
DEF_HELPER_3(mofei_spi_data_buf, i32, env, i32, i32)
