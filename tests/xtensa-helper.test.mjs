...
for (const scenario of ['merged','missing-definition','duplicate-registration','duplicate-exc-registration','already-selected']) {
 test(`Xtensa helper source selection: ${scenario}`,()=>{
  ...
  try {
   ...
   const result=run();
   if (scenario==='merged'||scenario==='already-selected'||scenario==='duplicate-exc-registration') {
