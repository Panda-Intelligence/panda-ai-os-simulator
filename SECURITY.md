...
Never expose a general network/R2 proxy or write guest imports into site code.
Changes to firmware/ROM loaders, FAT writes, bounds, origins, manifest digest
checks or native process paths require regression tests.
